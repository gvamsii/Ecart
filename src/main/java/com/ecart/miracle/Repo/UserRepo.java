...
public interface UserRepo extends JpaRepository<User, Long> {
    ...
    //This query is to get the all details from user table based on mobile and password for user login
	...
	//This query is for update password based on mobile when user click on forgot password
	@Modifying
	@Transactional
	...
	void updateUserCartQuantity(@Param("updated_quantity") String updated_quantity, @Param("cart") String cart,@Param("mobile") long mobile);
